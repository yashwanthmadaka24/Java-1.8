...
public class HealthData {
	...
	public static final HealthBenefit fullCover = new HealthBenefit("Full Cover",
			"Covers end to end expenses of all illness");
	public static final HealthBenefit cover50 = new HealthBenefit("Cover - 50%", "Insurance policy covers 50% of cost");
	public static final HealthBenefit allInclusiveCover = new HealthBenefit("All Inclusive Cover",
			"Inclusive of meds & transportation cost");
	...
	public static final HealthPlanGenericImpl comprehensiveHealthPlan = new HealthPlanGenericImpl("Comprehensive Health Plan",
			asList(cover50, allInclusiveCover), "NY");
	public static final HealthPlanGenericImpl maturityPlan = new HealthPlanGenericImpl("Maturity Plan",
			asList(fullCover, cover50, allInclusiveCover, accidentCover), "NY");
	public static final HealthPlanGenericImpl maternityPlan = new HealthPlanGenericImpl("Comprehensive Materity Plan", asList(fullCover),
			"IL");
	public static final HealthPlanGenericImpl oldAgePlan = new HealthPlanGenericImpl("Old Age Plan", asList(accidentCover), "NY");

	public static final Employee johnColtrane = new Employee("John Coltrane",
			asList(dentalPlan, comprehensiveHealthPlan),
			asList(new Dependent("Sarah", 16), new Dependent("Richard", 12)), 45);

	public static final Employee johnLennon = new Employee("John Lennon", asList(maturityPlan),
			asList(new Dependent("Mike", 14), new Dependent("Nancy", 12), new Dependent("Shakira", 5)), 35);

	// Sarah Corner does not have any dependents
	public static final Employee sarahCorner2 = new Employee("Sarah Corner2", asList(oldAgePlan),
			Collections.emptyList(), 35);

	public static final Employee sarahCorner = new Employee("Sarah Corner", asList(dentalPlan, oldAgePlan),
			Collections.emptyList(), 35);

	public static final Employee sarahCorner3 = new Employee("Sarah Corner3",
			asList(maturityPlan, maternityPlan, dentalPlan, oldAgePlan), Collections.emptyList(), 35);
	public static final Employee sarahCorner4 = new Employee("Sarah Corner4",
			asList(maturityPlan, maternityPlan, dentalPlan, oldAgePlan), Collections.emptyList(), 35);
